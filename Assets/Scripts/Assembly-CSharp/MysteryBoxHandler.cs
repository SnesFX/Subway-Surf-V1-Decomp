...
public class MysteryBoxHandler : MonoBehaviour
{
	...
	public GameObject trophyDiamond;

	public GameObject trophyGoldBar;

	public GameObject trophyChainClock;

	public GameObject trophyChainDollar;

	public GameObject trophyGoldSkull;

	public GameObject trophyHeadphones;

	public GameObject trophyLPBlack;

	public GameObject trophyTapeBlack;
	...
	private GameObject ChooseRewardPrefab(MysteryBoxReward reward)
	{
		...
		case MysteryBoxRewardType.token:
			...
			{
			case CharacterModels.TokenType.freshsStereo:
				gameObject = rewardTokenFresh;
				break;
			case CharacterModels.TokenType.trickysHat:
				gameObject = rewardTokenTricky;
				break;
			case CharacterModels.TokenType.spikesGuitar:
				gameObject = rewardTokenSpike;
				break;
			case CharacterModels.TokenType.YutanisUFO:
				gameObject = rewardTokenYutani;
				break;
			}
			break;
		case MysteryBoxRewardType.trophy:
			Missions.Instance.PlayerDidThis(Missions.MissionTarget.Trophies);
			switch (reward.trophyType)
			{
			case Trophies.Trophy.diamond:
				gameObject = trophyDiamond;
				break;
			case Trophies.Trophy.goldbar:
				gameObject = trophyGoldBar;
				break;
			case Trophies.Trophy.goldChainClock:
				gameObject = trophyChainClock;
				break;
			case Trophies.Trophy.goldChainDollar:
				gameObject = trophyChainDollar;
				break;
			case Trophies.Trophy.goldSkull:
				gameObject = trophyGoldSkull;
				break;
			case Trophies.Trophy.headphones:
				gameObject = trophyHeadphones;
				break;
			case Trophies.Trophy.lpBlack:
				gameObject = trophyLPBlack;
				break;
			case Trophies.Trophy.tapeBlack:
				gameObject = trophyTapeBlack;
				break;
			}
			break;
		}
